...
class OwnsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create own" do
    assert_difference('Own.count') do
      post owns_url, params: { own: { amount: @own.amount, product_id: @own.product_id, tajir_id: @own.tajir_id } }
    end
  ...
  test "should update own" do
    patch own_url(@own), params: { own: { amount: @own.amount, product_id: @own.product_id, tajir_id: @own.tajir_id } }
