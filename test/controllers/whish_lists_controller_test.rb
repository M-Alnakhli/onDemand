...
class WhishListsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create whish_list" do
    assert_difference('WhishList.count') do
      post whish_lists_url, params: { whish_list: { product_id: @whish_list.product_id, user_id: @whish_list.user_id } }
    end
  ...
  test "should update whish_list" do
    patch whish_list_url(@whish_list), params: { whish_list: { product_id: @whish_list.product_id, user_id: @whish_list.user_id } }
